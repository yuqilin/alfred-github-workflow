...
class Search
{
    ...
    private static function addUpdateCommands()
    {
        ...
        Workflow::addItem(Item::create()
            ...
            ->icon('file')
            ->arg('https://github.com/yuqilin/alfred-github-workflow/blob/master/CHANGELOG.md')
            ->randomUid()
        , false);
    }
    ...
    private static function addSystemCommands()
    {
        ...
        foreach ($cmds as $cmd => $file) {
            Workflow::addItem(Item::create()
                ...
                ->icon('file')
                ->arg('https://github.com/yuqilin/alfred-github-workflow/blob/master/'.strtoupper($file).'.md')
            );
        }
    }
}
